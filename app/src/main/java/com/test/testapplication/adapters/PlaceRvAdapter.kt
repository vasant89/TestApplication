...
import com.test.testapplication.databinding.RowSearchResultBinding
...
class PlaceRvAdapter(val imageLoader: Picasso) : RecyclerView.Adapter<PlaceRvAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(val binding: RowSearchResultBinding) : RecyclerView.ViewHolder(binding.root) {
